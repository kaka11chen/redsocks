OBJS := parser.o main.o redsocks.o log.o http-connect.o socks4.o socks5.o http-relay.o fully_transparent.o base.o base64.o md5.o http-auth.o utils.o redudp.o dnstc.o gen/version.o
SRCS := $(OBJS:.o=.c)
CONF := config.h
DEPS := .depend
OUT := redsocks
